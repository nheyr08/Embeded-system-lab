...
class DisplayImage(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.setWindowTitle('Example 5-1 - Displaying Images')
    ...
    @staticmethod
    def convertCVToQImage(image_file):
        ...
        return QImage(cv_image, width, height, bytes_per_line, QImage.Format_RGB888)
