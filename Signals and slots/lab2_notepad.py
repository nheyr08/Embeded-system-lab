...
class Notepad(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.setWindowTitle('Lab2-2 Notepad GUI')
    ...
    def notepadMenu(self):
        ...
        # TODO: add 3 actions related to file menu (actions already defined above)

        # Create edit menu and add actions
        edit_menu = menu_bar.addMenu('Edit')
        # TODO: add 3 actions related to edit menu (actions already defined above)

        # Create tools menu and add actions
        tool_menu = menu_bar.addMenu('Tools')
        # TODO: add 3 actions related to tools menu (actions already defined above)
    ...
    def clearText(self):
        ...
        answer = QMessageBox.question(self, "Clear Text",
                                      ...
                                      QMessageBox.Yes)
        # TODO: clear text_field if user click yes
    ...
    def findTextDialog(self):
        ...
        if ok and not self.text_field.isReadOnly():
            ...
            while self.text_field.find(find_text):
                ...
                # TODO: push selection to extra_selections list
    ...
    def chooseFont(self):
        ...
        if ok:
            # TODO: set current font of self.text_field
            pass
    ...
    def chooseFontColor(self):
        ...
        if color.isValid():
            # TODO: set text color of self.text_field
            pass
    ...
    def chooseFontBackgroundColor(self):
        ...
        color = QColorDialog.getColor()
        if color.isValid():
            # TODO: set text background color of self.text_field
            pass
    ...
    def aboutDialog(self):
        ...
        """
        QMessageBox.about(self, "About Notepad", "[2021 Fall] ESLab\n\nLab2-2 - Notepad GUI")
