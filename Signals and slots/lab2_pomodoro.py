...
POMODORO_TIME = 5000  # 25 minutes in milliseconds
SHORT_BREAK_TIME =30000  # 5 minutes in milliseconds
LONG_BREAK_TIME = 90000 # 15 minutes in milliseconds
...
class PomodoroTimer(QWidget):
    ...
    def initializeUI(self):
        ...
        self.setWindowTitle("Lab2-3 Pomodoro Timer")
    ...
    def resetCountDown(self):
        ...
        if self.current_tab_selected == 0:  # Pomodoro tab
            reset_time = self.calculateDisplayTime(self.pomodoro_limit)
            self.current_lcd.display(reset_time)
        elif self.current_tab_selected == 1:  # Short break tab
            reset_time = self.calculateDisplayTime(self.short_break_limit)
            self.current_lcd.display(reset_time)
        elif self.current_tab_selected == 2:  # Long break tab
            reset_time = self.calculateDisplayTime(self.long_break_limit)
            self.current_lcd.display(reset_time)
            

        # TODO: edit above if else statements to set reset_time correctly
    ...
    def updateTimer(self):
        ...
        if remaining_time == "00:00":
            ...
            # TODO: reduce current_time_limit by 1 second
            
            self.current_time_limit-=0.01
            self.current_lcd.display(remaining_time)
    ...
    def tabsSwitched(self, index):
        ...
        # TODO: update current_tab_selected
    ...
    def convertTotalTime(self, time_in_milli):
        ...
        # TODO: edit below to correct conversion
        minutes = time_in_milli/60000
        seconds = time_in_milli/1000
